...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-h8$qq#c4g!w4pz+hvzh$@s9uj-ov#3l*75=-z7s^k!6#%_(8-1')
...
INSTALLED_APPS = [
    ...
    'hotellapp.apps.HotellappConfig',
]
...
# Use DATABASE_URL if provided (e.g., Railway Postgres), otherwise fall back to SQLite for development
DATABASES = {
...
# Allow loading static assets from a project-level "static" folder during development
STATICFILES_DIRS = [BASE_DIR / 'static']
# Use compressed manifest storage for far-future caching in production
...
# Production security (enabled automatically when DEBUG is False)
if not DEBUG:
